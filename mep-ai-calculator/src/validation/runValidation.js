...
export const runValidation = () => {
  const tests = [
    ...
    {
      id: "UNIT-PEOPLE-001",
      name: "Occupant Sensible and Latent Load",
      run: testPeopleLoad,
    },
    {
      id: "UNIT-PEOPLE-002",
      name: "Occupant Diversity Load",
      run: testPeopleLoadWithDiversity,
    },
    {
      id: "UNIT-LIGHT-001",
      name: "Lighting Power Density Load",
      run: testLightingPowerDensity,
    },
    {
      id: "UNIT-LIGHT-002",
      name: "Lighting Fixture Schedule Load",
      run: testLightingFixtureSchedule,
    },
    {
      id: "UNIT-LIGHT-003",
      name: "Lighting Use Factor Load",
      run: testLightingUseFactor,
    },
    {
      id: "UNIT-EQUIP-001",
      name: "Equipment Sensible Load",
      run: testEquipmentLoad,
    },
    {
      id: "UNIT-EQUIP-002",
      name: "Equipment Sensible and Latent Load",
      run: testEquipmentLatentLoad,
    },
    {
      id: "UNIT-EQUIP-003",
      name: "Equipment Use Factor Load",
      run: testEquipmentUseFactor,
    },
    {
      id: "UNIT-VENT-001",
      name: "Outdoor Airflow People and Area",
      run: testOutdoorAirflowPeopleAndArea,
    },
    {
      id: "UNIT-VENT-002",
      name: "Outdoor Airflow Effectiveness",
      run: testOutdoorAirflowWithEffectiveness,
    },
    {
      id: "UNIT-VENT-003",
      name: "Ventilation Sensible Load",
      run: testVentilationSensibleLoad,
    },
    {
      id: "UNIT-VENT-004",
      name: "Ventilation Latent and Total Load",
      run: testVentilationLatentAndTotalLoad,
    },
    {
      id: "UNIT-INF-001",
      name: "Infiltration Airflow from ACH",
      run: testInfiltrationAirflowFromACH,
    },
    {
      id: "UNIT-INF-002",
      name: "Zero ACH Infiltration",
      run: testInfiltrationZeroACH,
    },
    {
      id: "UNIT-INF-003",
      name: "Infiltration Sensible Load",
      run: testInfiltrationSensibleLoad,
    },
    {
      id: "UNIT-INF-004",
      name: "Infiltration Latent and Total Load",
      run: testInfiltrationLatentAndTotalLoad,
    },
    {
      id: "UNIT-ROOM-001",
      name: "Room Load Assembly",
      run: testRoomLoadAssembly,
    },
    {
      id: "UNIT-ROOM-002",
      name: "Room Load Missing Components",
      run: testRoomLoadMissingComponents,
    },
    {
      id: "UNIT-ROOM-003",
      name: "Room Load Design Margin",
      run: testRoomLoadDesignMargin,
    },
