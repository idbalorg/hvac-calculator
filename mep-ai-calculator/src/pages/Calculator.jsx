...
function RoomEngineeringForm({ roomId, inputs, updateEngineering, updateEquipment, addEquipment, removeEquipment }) {
  ...
  return <div>
    <div className="input-grid">
      ...
      <Input label="Roof U-value" value={safe.roof.uValueWm2K} onChange={(v) => updateEngineering(roomId, "roof", "uValueWm2K", v)} type="number" min="0" placeholder="W/m²K" /><Input label="Roof CLTD" value={safe.roof.cltdK} onChange={(v) => updateEngineering(roomId, "roof", "uValueWm2K", v)} type="number" min="0" placeholder="K" />
