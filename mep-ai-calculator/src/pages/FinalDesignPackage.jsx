...
export default function FinalDesignPackage() {
  ...
  return <div className="container final-design-package">
    <div className="page-header"><div><p className="eyebrow">ENGINEERING WORKFLOW · STAGE 21</p><h1 className="title">Final Design Package</h1><p className="subtitle">Structured engineering schedules, standards basis, result traceability and design review.</p></div><span className="version-badge">Package 20.0</span></div>
