...
## Objective
Connect the Stage 40 engineering decision output to the existing explicit engineering approval gate without changing engineering calculations or silently resolving exceptions.

## Scope
- Pass the unified engineering decision into the approval gate.
...
## Validation
The Stage 41 validation gate must pass in CI before this stage is considered complete and before any production promotion.
